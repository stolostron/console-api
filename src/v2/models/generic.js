...
export default class GenericModel extends KubeModel {
  ...
  async getLogs(containerName, podName, podNamespace, clusterName) {
    ...
    if (cluster && cluster.length === 1) {
      ...
      return this.kubeConnector.get(`/apis/proxy.open-cluster-management.io/v1beta1/namespaces/${clusterNamespace}/clusterstatuses/${clusterNamespace}/log/${podNamespace}/${podName}/${containerName}?tailLines=1000`, { json: false }, true);
    }
